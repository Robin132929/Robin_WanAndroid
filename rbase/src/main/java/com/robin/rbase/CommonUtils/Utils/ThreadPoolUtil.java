...
public class ThreadPoolUtil {
    private volatile static ThreadPoolUtil mNormalThreadPoolUtil;
    ...
    public static ThreadPoolUtil getInstance() {
        if (mNormalThreadPoolUtil == null) {
            synchronized (ThreadPoolUtil.class) {
                if (mNormalThreadPoolUtil == null) {
                    mNormalThreadPoolUtil = new ThreadPoolUtil();
                }
            }
        }
        return mNormalThreadPoolUtil;
    }
