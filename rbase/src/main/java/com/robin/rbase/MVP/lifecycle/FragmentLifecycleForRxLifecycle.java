...
public class FragmentLifecycleForRxLifecycle extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    private static volatile FragmentLifecycleForRxLifecycle sFragmentLifecycleForRxLifecycle;

    @Inject
    public FragmentLifecycleForRxLifecycle() {
    }
    public static FragmentLifecycleForRxLifecycle getFragmentLifecycleForRxLifecycle() {
        if (sFragmentLifecycleForRxLifecycle == null) {
            synchronized (FragmentLifecycleForRxLifecycle.class) {
                if (sFragmentLifecycleForRxLifecycle == null) {
                    sFragmentLifecycleForRxLifecycle = new FragmentLifecycleForRxLifecycle();
                }
            }
        }
        return sFragmentLifecycleForRxLifecycle;
    }
