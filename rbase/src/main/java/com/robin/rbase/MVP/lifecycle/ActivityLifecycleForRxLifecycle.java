...
import static com.robin.rbase.MVP.lifecycle.FragmentLifecycleForRxLifecycle.getFragmentLifecycleForRxLifecycle;
...
public class ActivityLifecycleForRxLifecycle implements Application.ActivityLifecycleCallbacks {
    private static volatile ActivityLifecycleForRxLifecycle sActivityLifecycleForRxLifecycle;

    FragmentLifecycleForRxLifecycle mFragmentLifecycle=getFragmentLifecycleForRxLifecycle();

    @Inject
    public ActivityLifecycleForRxLifecycle() {
    }

    public static ActivityLifecycleForRxLifecycle getActivityLifecycleForRxLifecycle() {
        if (sActivityLifecycleForRxLifecycle == null) {
            synchronized (ActivityLifecycleForRxLifecycle.class) {
                if (sActivityLifecycleForRxLifecycle == null) {
                    sActivityLifecycleForRxLifecycle = new ActivityLifecycleForRxLifecycle();
                }
            }
        }
        return sActivityLifecycleForRxLifecycle;
    }
