...
public class WanAndroidMainFragmentPresenter extends BasePresenter<DataManager,WanAndroidMainFragmentContract.View> implements WanAndroidMainFragmentContract.Presenter {
    @Inject
