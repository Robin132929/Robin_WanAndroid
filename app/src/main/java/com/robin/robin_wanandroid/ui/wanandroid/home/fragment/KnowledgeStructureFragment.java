...
//
        ...
        FlexboxLayoutManager   flexboxLayoutManager=new FlexboxLayoutManager(getActivity(), FlexDirection.ROW, FlexWrap.NOWRAP);
...
//        konwledge_rv.setLayoutManager(flexboxLayoutManager);
...
//                    FlexboxLayoutManager.LayoutParams flex= new FlexboxLayoutManager.LayoutParams(konwledge_rv.getLayoutParams().width,konwledge_rv.getLayoutParams().height) ;
//                    konwledge_rv.setLayoutParams(flex);
                    konwledge_rv.setLayoutManager(gridLayoutManager);
//                    konwledge_rv.requestLayout();
...
//        });
    ...
    public void setStructureList1st(KnowledgeStructureBean bean) {
        ...
        mStructureDataList.addAll(bean.getData().subList(0,18));
        knowledgeListAdapter.notifyDataSetChanged();
//        knowledgeListAdapter1.notifyDataSetChanged();
